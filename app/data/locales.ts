export const translations = {
  ...
  nl: {
    ...
    rsvp: {
      ...
      submitButton: "Verstuur RSVP",
      successMessage:
        "Bedankt! We kijken ernaar uit om het met jullie te vieren.",
    },
    gallery: {
      title: "Onze Momenten",
    },
  ...
  tr: {
    ...
    rsvp: {
      ...
      submitButton: "LCV Gönder",
      successMessage:
        "Teşekkürler! Sizinle kutlamayı sabırsızlıkla bekliyoruz.",
    },
    gallery: {
      title: "Anılarımız",
    },
  ...
  fa: {
    ...
    rsvp: {
      ...
      submitButton: "ارسال پاسخ",
      successMessage: "متشکریم! بی‌صبرانه منتظر جشن گرفتن با شما هستیم.",
    },
    gallery: {
      title: "لحظات ما",
    },
...
export type Language = "en" | "nl" | "tr" | "fa";
